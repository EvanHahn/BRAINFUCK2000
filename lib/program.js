...
Program.prototype.runCommand = function(character) {
  ...
  if (character === '>') {
    ...
    if (this.tape[this.tapeIndex] < this.maxValue) {
      this.tape[this.tapeIndex] ++;
    } else if (this.wrap) {
      this.tape[this.tapeIndex] = this.minValue;
    }
  }
  else if (character === '-') {
    if (this.tape[this.tapeIndex] > this.minValue) {
      this.tape[this.tapeIndex] --;
    } else if (this.wrap) {
      this.tape[this.tapeIndex] = this.maxValue;
    }
  }
  else if (character === '.') {
